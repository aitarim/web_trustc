					...
					<div class="row ">
						...
						<div class=" col-lg-8 col-md-6 ">
							<div class="">
								...
								<div class="text-secondary ">
									<small><?php esc_html_e( 'Turn onto hide price in the Product page, Shop Page and Quote List Page', 'elex-request-a-quote' ); ?></small>
								</div>
							</div>
			...
			<div class="row align-items-center elex-rqust-quote-check-sec ">
				<div class="col-12 ">
					<div class="row mb-3">
						<div class=" col-lg-4 col-md-6 ">
							<div class="d-flex justify-content-between align-items-center">
								<h6 class="mb-0"><?php esc_html_e( 'Exclude User Role', 'elex-request-a-quote' ); ?>
								<span class = "elex_raq_go_premium_color">
									<?php 
									esc_html_e( '[Premium]', 'elex-request-a-quote' );
									?>
						...
						<div class=" col-lg-8 col-md-6 ">
							<div class="">
								<label class="elex-switch-btn ">
									<input disabled id="hide_cart_exclude_role" type="checkbox" name="hide_add_to_cart[exclude_roles][enabled]" <?php echo ( isset( $settings['hide_add_to_cart']['exclude_roles']['enabled'] ) && ( true === $settings['hide_add_to_cart']['exclude_roles']['enabled'] ) ) ? 'checked' : ''; ?> value="" class="elex-rqust-quote-check-sec-input-hidecart-role">

									<div class="elex-switch-icon round "></div>
								</label>
								<div class="text-secondary ">
									<small><?php esc_html_e( 'Turn on & Select the Roles for which the above settings should not be applied', 'elex-request-a-quote' ); ?> </small>
								</div>
							</div>
					...
					<div class="elex-rqust-quote-check-content-hidecart">
						<!-- exclude User roles -->
						<div class="row mb-3 align-items-center">
							<div class=" col-lg-4 col-md-6 ">
								<div class="d-flex justify-content-between align-items-center gap-2">
									<h6 class="mb-0"><?php esc_html_e( 'Exclude User Roles', 'elex-request-a-quote' ); ?></h6>
									<div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="Select the user roles that you want to exclude from the above applied settings">
							...
							<div class=" col-lg-8 col-md-6 ">
								<div class="row">
									<div class="col-xl-6 col-lg-9 col-md-12">
										<select name="hide_add_to_cart[exclude_roles][roles][]" style="width:100% !important" class="exclude_roles hide_cart_exclude_role   form-select border-2 border-secondary " multiple="true">
											<?php
											foreach ( $all_roles as $key => $role_name ) {

												if ( in_array( $role_name, $exclude_roles ) ) {
													?>
													<option value="<?php echo esc_html_e( $key ); ?>" selected><?php echo esc_html_e( $role_name ); ?></option>
												<?php } else { ?>
													<option value="<?php echo esc_html_e( $key ); ?>"><?php echo esc_html_e( $role_name ); ?></option>
											<?php 
												}
											} 
											?>
