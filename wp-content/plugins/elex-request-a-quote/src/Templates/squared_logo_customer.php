							...
							<table style="width: 100%;">
								<tr>
									<td style="border-bottom: 1px solid #c1c1c1; margin-bottom: 10px;">
										<h2 style="margin-bottom: 5px ; font-size:24px "><a
												href="<?php echo esc_url( get_edit_post_link( $order_id, '' ) ); ?>"><?php esc_html_e( '#' . $order_id ); ?></a></h2>
									</td>
								</tr>
								<tr>
									<td>
										<h5 style="margin:5px 0 5px 0; font-size:18px ">
