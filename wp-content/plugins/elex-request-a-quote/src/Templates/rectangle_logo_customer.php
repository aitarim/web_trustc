<table style="width: 80%;max-width: 700px; min-width: 350px; margin: 0 auto; background-color: #fff; padding: 20px;">
	<tbody>
		<tr>
			<td style="width: 100%;">
				<table style="width: 100%;text-align: center;">
					<tr>
						<td>
							<img style="width: 150px;" src="<?php echo esc_url( $company_logo ); ?>" alt="">
							<h6
								style="font-size: 16px; margin: 0px 0 10px 0; font-weight: 600;color: #000;text-align: center;">
					...
					<tr>
							...
							<table style="width: 100%; ">
								<tr style=" margin-bottom: 10px;">
									<td style="border-bottom: 1px solid #c1c1c1; ">
										<h2 style="margin: 5px 0 5px 0 ; font-size:24px ">
											<?php esc_html_e( 'Quote ', 'elex-request-a-quote' ); ?>
											<?php esc_html_e( '#' . $order_id ); ?>
										</h2>
									</td>
								</tr>
								<tr>
						...
						<td style="padding-left:25px;width: 50%;">
							<table style="width: 100%;">
								<tr style=" margin-bottom: 10px;">
									<td style="border-bottom: 1px solid #c1c1c1;">
										<h4 style="margin: 12px 0 5px 0 ; font-size:18px">
											<?php esc_html_e( 'Customer Details', 'elex-request-a-quote' ); ?>
										</h4>
									</td>
								</tr>
		...
		<tr>
			<td style="padding: 20px 0 30px 0;text-align: center;">
				...
				if ( 'quote-approved' === $order->get_status() ) {
					?>
					<button
						style="padding: 15px; width: 170px;margin: 0 5px; border-radius: 6px; color:#fff; background-color: #10518D; border: 1px solid #10518D;box-shadow: 3px 3px 16px #10518D80;"><?php echo ( '@payment_link' ); ?></button>
