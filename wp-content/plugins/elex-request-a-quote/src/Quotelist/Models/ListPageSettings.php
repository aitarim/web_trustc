	...
	public static function get_default_values() {
		...
		$data = array(
			'quote_list_page'    => array(
				...
				'title'                 => 'Quote List',
				'layout'                => array(
					'product_on_left_form_on_right' => true,
					'product_on_top_form_on_bottom' => false,
				),
				'show_if_list_empty'    => array(
					'illustration'           => true,
					'empty_text'             => array(
						'enabled' => true,
						'text'    => 'Your Quote List is Empty.',
					),
			...
			'additional_options' => array(
				...
				'add_more_items_button_label'       => 'Add More Items',
				'add_more_items_button_redirection' => self::get_page_url( 'shop' ),
			),
		);
		return $data;
	}
